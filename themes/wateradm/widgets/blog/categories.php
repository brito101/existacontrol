...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <a class="icon-plus-circle btn btn-green" href="<?= url("/admin/servicos/categoria"); ?>">Nova Categoria</a>
    </header>
                            ...
                            <div class="info">
                                ...
                                <div class="actions">
                                    <a class="icon-pencil btn btn-blue" title=""
                                       href="<?= url("/admin/servicos/categoria/{$category->id}"); ?>">Editar</a>

                                    <a class="icon-trash-o btn btn-red" href="#" title=""
                                       data-post="<?= url("/admin/servicos/categoria"); ?>"
                                       data-action="delete"
