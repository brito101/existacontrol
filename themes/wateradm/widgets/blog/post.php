...
<div class="mce_upload" style="z-index: 997">
    <div class="mce_upload_box">
        <form class="app_form" action="<?= url("/admin/servicos/post"); ?>" method="post" enctype="multipart/form-data">
...
<section class="dash_content_app">
    <?php if (!$post): ?>
        <header class="dash_content_app_header">
            <h2 class="icon-plus-circle">Novo Serviço</h2>
        </header>

        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/servicos/post"); ?>" method="post">
                <!-- ACTION SPOOFING-->
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            ...
            <a class="icon-link btn btn-green" href="<?= url("/servicos/{$post->uri}"); ?>" target="_blank" title="">Ver no
                site</a>
        </header>

        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/servicos/post/{$post->id}"); ?>" method="post">
                <!-- ACTION SPOOFING-->
