...
<section class="dash_content_app">
    <?php if (!$user): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/usuarios/usuario"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/usuarios/usuario/{$user->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
                ...
                <div class="label_g2">
                    <label class="label">
                        ...
                        <select name="level" required>
                            ...
                            <option <?= $select(2); ?> value="2">Condomínio</option>
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-warning"
                       data-post="<?= url("/admin/usuarios/usuario/{$user->id}"); ?>"
                       data-action="delete"
