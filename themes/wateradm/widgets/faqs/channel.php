...
<section class="dash_content_app">
    <?php if (!$channel): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/canal"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/canal/{$channel->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-error"
                       data-post="<?= url("/admin/faq/canal/{$channel->id}"); ?>"
                       data-action="delete"
