...
<section class="dash_content_app">
    <?php if (!$question): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/pergunta/{$channel->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            ...
            <a href="<?= url("/admin/faq/pergunta/{$channel->id}"); ?>"
               class="icon-plus-circle btn btn-green">Nova Pergunta</a>
        </header>

        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/pergunta/{$channel->id}/{$question->id}"); ?>"
                  method="post">
                <!--ACTION SPOOFING-->
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-error"
                       data-post="<?= url("/admin/faq/pergunta/{$channel->id}/{$question->id}"); ?>"
                       data-action="delete"
