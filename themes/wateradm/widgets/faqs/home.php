...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <a class="icon-plus-circle btn btn-green" href="<?= url("/admin/faq/canal"); ?>">Novo Canal</a>
    </header>
                    ...
                    <?php foreach ($channels as $channel): ?>
                        <article class="radius">
                            <header>
                                ...
                                <div>
                                    <a href="<?= url("/admin/faq/canal/{$channel->id}"); ?>"
                            ...
                            <div>
                                ...
                                $edit = function ($id) use ($channelId) {
                                    $url = url("/admin/faq/pergunta/{$channelId}/{$id}");
