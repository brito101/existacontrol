    ...
    <div class="dash_content_app_box">
        <section class="app_dash_home_stats">
            <article class="control radius">
                <h4 class="icon-bar-chart">Controle</h4>
                <p><b>Condomínios:</b> <?= $control->condominium; ?></p>
                <p><b>Apartamentos:</b> <?= $control->apartments; ?></p>
                <p><b>Assinantes:</b> <?= $control->subscriptions; ?></p>
                <p><b>Demonstrativos:</b> <?= $control->invoices; ?></p>
            </article>

            <article class="service radius">
                <h4 class="icon-pencil-square-o">Serviços</h4>
                <p><b>Serviços:</b> <?= $services->posts; ?></p>
                <p><b>Rascunhos:</b> <?= $services->drafts; ?></p>
                <p><b>Categorias:</b> <?= $services->categories; ?></p>
            </article>

            <article class="users radius">
                <h4 class="icon-user">Usuários</h4>
                <p><b>Usuários:</b> <?= $users->users; ?></p>
                <p><b>Gerentes:</b> <?= $users->condominiuns; ?></p>
            ...
            <div class="app_dash_home_trafic_list">
                <?php if (!$online): ?>
                    <div class="message info icon-info">
                        Não existem usuários online navegando no site neste momento. Quando houver, você
                        poderá monitoriar todos por aqui.
                    </div>
                <?php else: ?>
                    <?php foreach ($online as $onlineNow): ?>
                        <article>
                            <h4>[<?= date_fmt($onlineNow->created_at, "H\hm"); ?> - <?=
                                date_fmt($onlineNow->updated_at,
                                        "H\hm");
                                ?>]
