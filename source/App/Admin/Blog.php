...
class Blog extends Admin {
    ...
    public function home(?array $data): void {
        ...
        if (!empty($data["s"])) {
            $s = str_search($data["s"]);
            echo json_encode(["redirect" => url("/admin/servicos/home/{$s}/1")]);
            return;
        }
        ...
        if (!empty($data["search"]) && str_search($data["search"]) != "all") {
            ...
            if (!$posts->count()) {
                ...
                redirect("/admin/servicos/home");
            }
        }

        $all = ($search ?? "all");
        $pager = new Pager(url("/admin/servicos/home/{$all}/"));
    ...
    public function post(?array $data): void {
        ...
        if (!empty($data["action"]) && $data["action"] == "create") {
            ...
            $json["redirect"] = url("/admin/servicos/post/{$postCreate->id}");
        ...
        if (!empty($data["action"]) && $data["action"] == "update") {
            ...
            if (!$postEdit) {
                ...
                echo json_encode(["redirect" => url("/admin/servicos/home")]);
                return;
            }
    ...
    public function categories(?array $data): void {
        ...
        $pager = new Pager(url("/admin/servicos/categorias/"));
    ...
    public function category(?array $data): void {
        ...
        if (!empty($data["action"]) && $data["action"] == "create") {
            ...
            $json["redirect"] = url("/admin/servicos/categoria/{$categoryCreate->id}");
        ...
        if (!empty($data["action"]) && $data["action"] == "update") {
            ...
            if (!$categoryEdit) {
                ...
                echo json_encode(["redirect" => url("/admin/servicos/categorias")]);
                return;
            }
