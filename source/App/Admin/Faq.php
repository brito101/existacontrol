...
class Faq extends Admin
{
    ...
    public function channel(?array $data): void
    {
        ...
        if (!empty($data["action"]) && $data["action"] == "create") {
            ...
            echo json_encode(["redirect" => url("/admin/faq/canal/{$channelCreate->id}")]);
    ...
    public function question(?array $data): void
    {
        ...
        if (!empty($data["action"]) && $data["action"] == "create") {
            ...
            echo json_encode(["redirect" => url("/admin/faq/pergunta/{$questionCreate->channel_id}/{$questionCreate->id}")]);
