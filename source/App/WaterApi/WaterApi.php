 ...
 */
class WaterApi extends Controller {
    ...
    public function __construct() {
        ...
        $request = $this->requestLimit("waterApi", 1, 1);
        if (!$request) {
            exit;
        }
     ...
     * @return WaterApi
     */
    protected function call(int $code, string $type = null, string $message = null, string $rule = "errors"): WaterApi {
     ...
     * @return WaterApi
     */
    protected function back(array $response = null): WaterApi {
        if (!empty($response)) {
